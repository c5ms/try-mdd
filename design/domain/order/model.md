...
| bulkOrder | BulkOrder | 大批量生产的正式订单 | 订单 |
...
| 订单聚合 | 生产管理聚合 | productionId |
| 订单聚合 | 财务管理聚合 | orderId（双向） |
...
| # | 待定内容 | 来源 | 状态 |
|---|----------|------|------|
| 1 | 订单状态流转（创建到完成的完整流程） | 用户原话 | 待用户研究确认 |
| 2 | 订单编号生成规则 | 系统架构师评审 | 待确认 |
| 3 | 订单与生产单的关联规则 | 生产跟单员评审 | 待生产管理领域设计 |
| 4 | 客户信用额度校验具体规则 | 财务主管评审 | 待财务管理领域设计 |
| 5 | 订单成本核算字段设计 | 财务主管评审 | 待确认 |
| 6 | SKU编码规则 | 系统架构师评审 | 待确认 |